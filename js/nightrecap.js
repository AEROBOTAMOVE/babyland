...
(function () {
  ...
  function нощнаРавносметка(container) {
    ...
    // 🌅 15.09 (E2E „родила“, RODILA-1, MutationObserver: добавена на 642 мс, махната на 1204 мс):
    //   отметката „видяна днес“ се пишеше в МИГА на рисуването, а картата „Днес“ се пре-рисува
    //   след зареждане — равносметката изчезваше след секунда и не се връщаше. Тя стои цялата
    //   сутрин (6–11 ч): всяко пре-рисуване я слага наново (горе е идемпотентно).
