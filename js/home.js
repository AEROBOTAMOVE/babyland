...
(function () {
  ...
  const DAY = [
    ...
    { h: 13, e: '🥄', t: 'Обяд', s: 'Главата е празна, бебето — гладно. <strong>„Какво за обяд?“</strong> вади идея от любимите му храни.', room: 'Захранване' },
    ...
    { h: 19, e: '📸', t: 'Вечер', s: 'Той се засмя както никога. <strong>Снимката на деня</strong> влиза в Реката — историята ви се пише сама.', room: 'Дневник на мама' },
    { h: 21, e: '📖', t: 'Лека нощ', s: '<strong>Приказка с неговото име</strong> — измисля се сега и никога не е една и съща.', room: 'Развитие и игри' },
