...
(function () {
  ...
  function contractionsCard() {
    ...
    function преброй() {
      ...
      const дял = и / дадени;
      if (дял >= 0.7) {
        // 🔴 11.08 (обиколка като майка, 28-та седмица): този отговор пращаше
        ...
        //    точно обратното на същата жена: „Ти си в 28-та седмица. Редовни
        ...
        out.innerHTML = седмица < 37
          ...
          <p class="pg-alarm">🚨 Ти си в ${седмица}-та седмица. Преди <strong>37-та</strong> правилото 5-1-1 НЕ важи — не чакай час, звънни на лекаря си или в родилното <strong>сега</strong>. При изтекли води, кървене или силна болка — тръгвай веднага.<br><a class="ro-sos" href="tel:112">📞 112</a></p>`
          : `<p class="ct-real">Звучи като <strong>истински контракции</strong>.</p>
