  ...
  function помпаКарта(root) {
    ...
    function refresh() {
      ...
      out.innerHTML = изтекло < -60000
        ...
        : (isFinite(m) ? `Последно (${страна(last.s)}${last.ml ? ' · ' + last.ml + ' мл' : ''}) преди <strong>${h ? h + ' ч ' : ''}${m} мин</strong>.`
                       : 'Записът за последното изцеждане не се чете. Следващото ще се брои нормално. 💜');   // 🔴 26.08 (ИЗМЕРЕНО): даваше „преди NaN мин"
