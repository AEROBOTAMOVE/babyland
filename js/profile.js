...
(function () {
  ...
  function профил(root) {
    ...
    try { if (window.BL_STORAGE) { const d = BL_STORAGE.чети(); const сбор = (d.общо || 0) + (d.друго || 0); размер = сбор > 1048576 ? (сбор / 1048576).toFixed(1) + ' MB' : Math.round(сбор / 1024) + ' KB'; } } catch (e) {}
    ...
    root.appendChild(el('p', 'prof-legal', '🔒 Всичко тук е само на този телефон. Смяна на телефон: свали копието тук, а на новия телефон го качи от „Инструменти → Възстанови от файл“.'));
  }
