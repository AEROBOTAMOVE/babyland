...
(function () {
  ...
  const ВЕЩЕСТВО = /захар|подслад|осол|билк|отвар|лайк|копър|копарч|бира|вино|алкохол|спирт|кафе|фреш|компот|орех|ядк|чесън|жълтък|мляко|млечн|грис|сол\s|солта|сироп|мазнин|ментол|възглавн|одеял|завивк|юрган|(^|\s)(мед|сол|вода|водичк|водич|чай|сок|каша|кашк|масло)/i;
