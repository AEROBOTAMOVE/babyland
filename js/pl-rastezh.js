...
(function () {
  ...
  function графиката(данни, к, Ш, ид, избД, с) {
    ...
    // Полетата са свити (ляво 30→27, дясно 22→19): страната на списъка порасна до 141 px и
    // графиката падна от 196 на ~183 px. Проверено, че числата на оста („120“ = най-широкото)
    // и четирите дати пак се побират — вече с МЕРЕНИ ширини, не с оценки.
    const пл = 27, пд = 12, пг = 34, пдн = 28;           // полета: ляво (числата), дясно, горе, долу (датите)
    const x0 = пл + 16, x1 = Ш - пд - 19;               // точките не лепнат по ръбовете
