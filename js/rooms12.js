...
(function () {
  ...
  function ritualCard() {
    ...
    const тонДнес = тон.d === today() ? тон.v : '';
    const позволени = тонДнес === 'тихо' ? ['т']
  ...
  function shareFindCard() {
    ...
    b.addEventListener('click', async () => {
      ...
      catch (e) { out.textContent = 'Телефонът не дава. Препиши го на ръка — пак върши работа.'; }
      fx().buzz(8);
    });
