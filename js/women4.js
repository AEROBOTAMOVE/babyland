...
(function () {
  ...
  function работаCard() {
    ...
    дата.addEventListener('change', () => {
      st.date = дата.value; запази(); рисувайЛента(); нанадолу();
    ...
    const нанадолу = () => {
      ...
      let ч = 0;
      const пази = () => { st.first = т.value.slice(0, 900); запази(); };
      ...
      месеци.forEach(k => {
        ...
        б.addEventListener('click', () => {
          ...
          Promise.resolve(питай).then(да => {
            if (да) { delete st[k]; save('bl_wm_inframe', st); рисувай(); знКадър.кажи('Снимката от ' + k + ' е махната.'); }
    ...
    const рисувайМои = () => {
      ...
      st.slice().reverse().forEach((x, ri) => {
        ...
        трий.addEventListener('click', () => {
          ...
          st.splice(i, 1); save('bl_wm_replies', st); рисувайМои(); fx().buzz(8);
