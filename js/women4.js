...
(function () {
  ...
  function париCard() {
    ...
    c.appendChild(el('p', 'jr-privacy',
      'Спряха ти заплатата, не стойността. Само че никой не го казва така — казват „сега си вкъщи“ и толкова. И в един момент се хващаш, че се извиняваш, докато искаш пари за червило. Тук няма да броим пелени и няма да правим семеен бюджет — за това си има други места. Тук са твоите пари.'));
