  ...
  function лента(ниво, поле) {
    ...
    if (ниво === 'mother') {
      вътре = '<strong>Прочетох те. 🤍</strong><br>Това, което написа, е тежко и не бива да го носиш сама точно сега. ' +
        ...
        // 15.09: номерът остава (безплатен, денонощен, създаден за децата И семействата им —
        //   nmd.bg), но „Линия за деца" казваше на майката, че не е за нея.
        '<a class="gd-btn" href="tel:116111">📞 116 111 · за децата и семействата</a>' +
