...
(function () {
  ...
  const ИКОНИ = {
    ...
    // Захранване
    'Днес на масата': ['ico-f', 1, 0], 'Храните': ['ico-f', 1, 2], 'Внимавай с това': ['ico-a', 2, 2], 'Помним': ['ico-f', 1, 3],
    // Здраве и SOS
    ...
    // Развитие и игри
    'Расте и учи': ['ico-b', 1, 3], 'Играем заедно': ['ico-b', 2, 0], 'Първите пъти': ['ico-g', 1, 3], 'Творби и спомени': ['ico-g', 2, 0], 'Кътче за мама': ['ico-g', 1, 2],
    // Инструменти
    'Какво предстои': ['ico-f', 3, 1], 'Чеклисти': ['ico-f', 3, 2], 'Сметки и размери': ['ico-b', 3, 2], 'Списъци и гардероб': ['ico-b', 3, 3],
