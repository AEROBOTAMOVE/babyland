...
(function () {
  ...
  const К = {
    ...
    // личицата за настроение (img/art/lica.webp, 4×2 — филцови копчета; проверителят на „Дневник“:
    //   петте системни емоджита бяха единственото плоско нещо на иначе плюшен екран)
    '🙂': ['m', 0, 0, 'c'], '😊': ['m', 0, 0, 'c'], '🥰': ['m', 0, 1, 'p'], '😍': ['m', 0, 1, 'p'], '😐': ['m', 0, 2, 'p'],
    '😕': ['m', 0, 2, 'p'], '😔': ['m', 0, 3, 'm'], '🙁': ['m', 0, 3, 'm'], '😩': ['m', 1, 0, 'l'], '😫': ['m', 1, 0, 'l'],
    '😢': ['m', 1, 1, 's'], '😭': ['m', 1, 1, 's'], '😂': ['m', 1, 2, 'b'], '😆': ['m', 1, 2, 'b'], '😞': ['m', 1, 3, 'm'],
