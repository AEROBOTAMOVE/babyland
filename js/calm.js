...
(function () {
  ...
  function brainDumpCard() {
    ...
    t.placeholder = 'пране\nда звънна на лекаря\nзабравих да ям\n…';
    // 🟠 25.08 (dev/parvata_vrata.js, ИЗМЕРЕНО): това беше ЕДИНСТВЕНОТО голямо
    //    поле за писане в моите файлове без издърпване при фокус — всички
    //    останали го имат (daily.js:283, firstday.js:331, askfield.js,
    //    onboard.js, lab.js:583). А тук мама пише НЯКОЛКО РЕДА (4 реда поле) в
    //    карта, която стои НАДОЛУ в стаята: клавиатурата изяжда долната трета и
    //    тя не вижда какво пише. Точно в картата „за момента, в който всичко е
    //    много“. ПЪТ НАЗАД: махни следващите три реда.
