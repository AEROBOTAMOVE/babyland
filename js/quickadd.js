...
(function () {
  ...
  function mountQuickAdd(container) {
    ...
    // 🔎 08.09, одит на интерфейса: това беше ЕДИНСТВЕНИЯТ от 70 видими
    //   клик-елемента без достъпно име. Подсказката НЕ е име — тя изчезва
    //   щом майката започне да пише, а екранният четец я чете различно в
    //   различните браузъри. Съседният бутон и полето на чата вече имат
    //   aria-label; тук просто липсваше.
    inp.setAttribute('aria-label', 'Таен ред за дневника');
