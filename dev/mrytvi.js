...
// ── ЧЕСТНОСТ ЗА ИЗКЛЮЧЕНАТА САМОПРОВЕРКА (01.09.2026, ВЪЛНА 1.3) ──
// Този уред ИМА самопроверка (--proba: внася нарочни дефекти и иска да ги
// види в списъка). Но по подразбиране тя не се пуска — а мълчаливо изключена
// самопроверка е същото като липсваща: числата изглеждат еднакво.
if (!пробни.length) {
  console.log('');
  console.log('  ⚠️ САМОПРОВЕРКАТА НЕ Е ПУСНАТА. Числата горе са неподписани.');
  console.log('     Пусни  node dev/mrytvi.js --proba  — внася нарочни мъртви ключове');
  console.log('     и пада, ако уредът не ги види.');
}
